...
async def play(_, message: Message):
    ...
    if await is_active_chat(message.chat.id):
        ...
        try:
            ...
            return await fallen.edit_text(
                "» ᴛᴇʟᴇɢʀᴀᴍ ʜᴀᴠɪɴɢ sᴏᴍᴇ ɪɴᴛᴇʀɴᴀʟ ᴘʀᴏʙʟᴇᴍs, ᴘʟᴇᴀsᴇ ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ."
            )
        except UnMuteNeeded:
            return await fallen.edit_text(
        ...
        await message.reply_photo(
            photo=imgt,
            caption=f"**➻ 𝕾𝖙𝖆𝖗𝖙𝖊𝖉 𝕾𝖙𝖗𝖊𝖆𝖒𝖎𝖓𝖌**\n\n‣ **𝔗𝔦𝔱𝔩𝔢 :** [{title[:27]}](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n‣ **𝔇𝔲𝔯𝔞𝔱𝔦𝔬𝔫 :** `{duration}` ᴍɪɴᴜᴛᴇs\n‣ **ℜ𝔢𝔮𝔲𝔢𝔰𝔱𝔢𝔡 𝔟𝔶 :** {ruser}",
            reply_markup=buttons,
        )
